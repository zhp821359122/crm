# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-09-16 14:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('day_num', models.IntegerField(help_text='此处填写第几节课或者第几天课程...必须为数字', verbose_name='节次')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sales.ConsultRecord', verbose_name='某节课程')),
